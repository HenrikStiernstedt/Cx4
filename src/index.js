...
class Board extends React.Component {
  renderSquare(i) {
     return ( <Square value={ (this.props.squares[i] == null ? null : this.props.squares[i].symbol)} color = { (this.props.squares[i] == null ? null : this.props.squares[i].color)}
...
class Game extends React.Component {
  ...
  handleClick(i) {
    ...
    this.setState({
      ...
      redIsNext: (this.state.xIsNext ? !this.state.redIsNext : this.state.redIsNext),
